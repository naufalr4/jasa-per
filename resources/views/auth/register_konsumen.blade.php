    ...
    <div class="flex py-10 md:py-20 px-5 md:px-32 bg-gray-200 min-h-screen">
        <div class="flex shadow w-full flex-col-reverse lg:flex-row">
            <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
                ...
                <form action="/register_konsumen " class="mt-10" method="POST">
                    @csrf
                    <div class="my-3">
                        <label class="font-semibold" for="nama_konsumen">Nama Konsumen</label>
                        <input required type="text" placeholder="Nama Konsumen" name="nama_konsumen" id="nama_konsumen"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                        <label class="font-semibold" for="no_hp">No Hp</label>
                        <input required type="text" placeholder="No Hp" name="no_tlp" id="no_tlp"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                    ...
                    <div class="my-3">
                        ...
                        <input required type="text" placeholder="provinsi" name="provinsi"
                    ...
                    <div class="my-3">
                        ...
                        <input required type="text" placeholder="kecamatan" name="kecamatan"
                            id="kecamatan" class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                        <label class="font-semibold" for="alamat">alamat</label>
                        <input required type="text" placeholder="alamat" name="alamat"
                            id="alamat" class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-5">
                        <button type="submit"
                ...
                <span>Have an account? <a href="/login_konsumen" class="text-blue-400 hover:text-blue-600">Login
                        here.</a></span>
            </div>
