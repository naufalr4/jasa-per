            ...
            <div class="col-md-12">
                <form class="form-subkategori">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_subcategory" 
    ...
    <script>
        $(function(){
            ...
            $('.modal-tambah').click(function(){
                ...
                $('input[name="nama_subcategory"]').val('')
            ...
            $(document).on('click', '.modal-ubah', function(){
                ...
                $.get('/api/subcategories/'+ id, function({data}){
                    $('input[name="nama_subcategory"]').val(data.nama_subcategory);
